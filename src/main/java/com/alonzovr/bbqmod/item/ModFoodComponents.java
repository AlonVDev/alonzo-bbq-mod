...
public class ModFoodComponents {
    ...
    public static final FoodComponent SAUCED_PORKCHOP = new FoodComponent.Builder().hunger(4).saturationModifier(0.4f).meat().build();
    public static final FoodComponent COOKED_SAUCED_PORKCHOP = new FoodComponent.Builder().hunger(10).saturationModifier(1.0f).meat().build();
